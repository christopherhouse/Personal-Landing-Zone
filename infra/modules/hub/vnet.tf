locals {
  ...
  #   GatewaySubnet            -> /27 at offset 24 (10.0.3.0/27 within 10.0.0.0/22)
  #   AzureDnsResolverInbound  -> /28 at offset 50 (10.0.3.32/28 within 10.0.0.0/22)
  #   snet-<prefix>-hub-reserve -> /24 at offset 0 (10.0.0.0/24)
